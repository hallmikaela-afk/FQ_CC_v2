        ...
        <div className="p-6">
          ...
          <div className="flex items-center gap-2 text-[13px] font-body text-fq-muted mb-4 flex-wrap">
            ...
            {project.estimated_budget && (
              <span>{project.estimated_budget} budget</span>
            )}
            {project.service_tier && (
              <span className="ml-2 text-[11px] font-medium text-fq-accent bg-fq-light-accent px-2.5 py-0.5 rounded-full">
                {project.service_tier}
              </span>
            )}
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-1.5">
              ...
              {project.overdue_count > 0 && (
                <span className="ml-2 text-[11px] font-body font-medium text-white bg-fq-alert px-2 py-0.5 rounded-full">
