  ...
  const projects: Project[] = useMemo(() => {
    ...
    return rawProjects.map((p) => {
      ...
      return {
        ...
        client1_email: p.client1_email || undefined,
        client2_email: p.client2_email || undefined,
        client1_phone: p.client1_phone || undefined,
        client2_phone: p.client2_phone || undefined,
